...
const Sidebar = () => {
  return (
    <div className="absolute inset-y-0 left-0 flex w-60 items-end bg-white pb-7 pl-8 pr-14 pt-24 text-left text-sm font-semibold leading-loose tracking-wide">
      <div className="absolute inset-x-5 top-4 flex h-48 flex-col items-center justify-between">
        <div className="flex h-14 flex-col items-center justify-between gap-y-7 self-stretch">
      ...
      <div className="relative flex flex-grow flex-col items-start justify-center gap-y-7 self-stretch">
        <div className="flex items-center justify-between gap-x-4">
          ...
          <div className="text-orange-500">My Projects</div>
        </div>

        <div className="flex h-7 items-center justify-between self-stretch text-neutral-300">
          ...
          <div className="self-stretch">Sample Projects</div>
        </div>
        <div className="flex w-36 flex-grow flex-col items-center justify-end pt-7">
          <div className="flex flex-grow flex-col items-start justify-center gap-y-7 self-stretch">
            <div className="flex h-7 w-20 items-center justify-center gap-x-2.5 text-neutral-300">
              <div className="h-7 w-7">
                <svg
                  width="100%"
                  height="100%"
              ...
              <div className="self-stretch">Apps</div>
            </div>
            <div className="flex h-7 items-center justify-center gap-x-3.5 self-stretch text-neutral-300">
              <div className="h-6 w-6">
                <svg
                  width="100%"
                  height="100%"
              ...
              <div className="self-stretch">Intro to Necleo</div>
            </div>
            <div className="flex flex-grow flex-col items-center justify-end self-stretch pt-96 text-neutral-300">
              <div className="flex items-center justify-between gap-x-2.5 self-stretch">
                <div className="h-7 w-7">
                  <svg
                    width="100%"
                    height="100%"
                ...
                {/* Your circle SVG or any other element */}
              </div>
            </div>
            <div className="flex h-7 w-28 items-center justify-center gap-x-2.5 text-neutral-300">
              <div className="h-7 w-7">
                <svg
                  width="100%"
                  height="100%"
              ...
              <div className="self-stretch">Feedback</div>
            </div>
            <div className="flex h-7 w-24 items-center justify-center gap-x-2.5 text-black">
              <div className="h-7 w-7">
                <svg
                  width="100%"
                  height="100%"
              ...
              <div className="self-stretch">Collapse</div>
            </div>
          </div>
        </div>
      </div>
